...
Shader "S_Dissolve"
{
	Properties
	{
		...
		[PerRendererData]_DissolveGuide("Dissolve Guide", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult14 = clamp( (-4.0 + (( (-0.6 + (( 1.0 - _DissolveAmount ) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2DNode15_g13.r ) - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=15401
0;92;1185;926;1171.321;-35.06839;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-1273.729,772.1158;Float;False;Property;_DissolveAmount;DissolveAmount;3;0;Create;True;0;0;False;0;0;0.455;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;3;-981.9378,782.9211;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;61;-1013.168,888.9035;Float;True;Property;_DissolveGuide;Dissolve Guide;8;1;[PerRendererData];Create;True;0;0;False;0;None;e28dc97a9541e3642a48c0e3886688c5;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.FunctionNode;71;-737.9997,921.7427;Float;False;Move;0;;13;24f5866c41dc8f640b75511a997c62d4;0;1;16;SAMPLER2D;0;False;5;COLOR;0;FLOAT;17;FLOAT;18;FLOAT;19;FLOAT;20
...
Node;AmplifyShaderEditor.DynamicAppendNode;18;-676.7198,317.4723;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;22;-467.9961,333.8081;Float;True;Property;_BurnColors;Burn Colors;7;0;Create;True;0;0;False;0;None;64e7766099ad46747a07014e44d0aea1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8C4E4C7F8C269A71ACC639DE64E649D53BE06A8F