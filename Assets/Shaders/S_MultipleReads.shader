...
Shader "S_MultipleReads"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = (( _Enable == 0 ) ? tex2DNode11 :  ( saturate( 2.0f*blendOpDest12*blendOpSrc12 + blendOpDest12*blendOpDest12*(1.0f - 2.0f*blendOpSrc12) )) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=15401
0;92;1185;926;1574.934;349.4867;1.3;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1168.601,68.51421;Float;True;Property;_Albedo;Albedo;2;0;Create;True;0;0;False;0;b297077dae62c1944ba14cad801cddf5;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-957.6045,391.8529;Float;False;Property;_Tilling;Tilling;1;0;Create;True;0;0;False;0;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;4;-687.7469,-255.7122;Float;False;Property;_Enable;Enable;0;0;Create;True;0;0;False;0;0;0;0;1;INT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;12;-283.2714,159.78;Float;False;SoftLight;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3A64487C5738B150B3C5ADEEC81F193C9390542F